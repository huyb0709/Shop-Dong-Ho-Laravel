...
{     
    ...
    public function save_product(Request $request){
        ...
        //current có nghĩa là lấy tên trước dấu "." 
        $new_image = rand(0,99).'.'.$get_image->getClientOriginalExtension();
        //getClientOriginalExtension(); là lấy đuôi mở rộng , vd: .jpg , .png
    ...
    public function details_product($product_id){
        ...
        return view('pages.sanpham.show_details')->with('category',$category_product)->with('brand',$brand_product)->with('product_details',$details_product)->with('relate',$related_product);
