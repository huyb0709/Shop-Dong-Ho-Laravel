                        ...
                        ?>
                            <div class="position-center">
                                ...
                                <div class="form-group">
                                    ...
                                    <img src="{{URL::to('public/upload/product/'.$product->product_image)}}" height="100" width="100">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea style="resize: none" rows="8"  class="form-control" name="product_content" id="exampleInputPassword1"> {{$product->product_content}} </textarea>
                                </div>
                                <div class="form-group">
