                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="logo pull-left">
                                <a href="{{URL::to('/trang-chu')}}"><img src="{{('public/frontend/images/logofull.png')}}" alt="" /></a>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-5">
                            ...
                            <div class="search_box pull-right">
                                ...
                                <input type="submit" style="margin-top:0;color:#666" name="search_items" class="btn btn-info btn-sm" value="Tìm Kiếm">
                            </div>
                            </form>
                        </div>
                    </div>
